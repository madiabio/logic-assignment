...
proof of depth $k$ is found on iteration $k$.  Because this directly
addresses the most common failure mode on provable benchmarks, the
\texttt{id} engine alone should account for the majority of additional
solves over \texttt{naive}.
