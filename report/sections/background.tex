...
LK$'$ used in Hou~\cite{hou2021fundamentals} differs from LK by eliminating
all structural rules---weakening, contraction, exchange, and cut---and
absorbing their effects into the logical rules; sequent contexts are treated
as sets rather than sequences. To compensate for the absence of contraction,
the quantifier rules $\forall L$ and $\exists R$ are made \emph{reusable}:
the original quantified formula is retained on its side of the sequent after
