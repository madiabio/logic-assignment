...
fof(conclusion,conjecture,~((((contain(x, excessiveeroticcontent) & contain(x, excessiveviolentcontent)) | infrozenseries(excessiveviolentcontent)) & ~(((contain(x, excessiveeroticcontent) & contain(x, excessiveviolentcontent)) & infrozenseries(excessiveviolentcontent)))))).
