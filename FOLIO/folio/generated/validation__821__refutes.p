...
fof(conclusion_negated,conjecture,~(((growthstock(ko) | boughttoearnprofitfrom(ko, earnprofit, rapidpriceappreciation)) => (~(stock(ko)) & ~(boughttoearnprofitfrom(ko, rapidpriceappreciation)))))).
