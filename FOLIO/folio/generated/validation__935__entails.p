...
fof(conclusion,conjecture,(privatecompany(harvardweeklybookclub) => ((legalobligation(harvardweeklybookclub) | createdunderlaw(harvardweeklybookclub)) & ~((legalobligation(harvardweeklybookclub) & createdunderlaw(harvardweeklybookclub)))))).
