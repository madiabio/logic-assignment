...
fof(conclusion_negated,conjecture,~((privatecompany(harvardweeklybookclub) => ((legalobligation(harvardweeklybookclub) | createdunderlaw(harvardweeklybookclub)) & ~((legalobligation(harvardweeklybookclub) & createdunderlaw(harvardweeklybookclub))))))).
