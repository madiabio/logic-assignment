...
fof(conclusion_negated,conjecture,~(((canparticipatein(ekaterina, c_2024unitedstateselection) | managerat(vladimir, gazprom)) & ~((canparticipatein(ekaterina, c_2024unitedstateselection) & managerat(vladimir, gazprom)))))).
